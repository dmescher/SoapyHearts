...
public class Deck {
	...
	public static Deck testDeck1() {
		...
		// Player 0
		rtnval.setCard(0,  new Card(6, 3, "EIGHT OF SPADES")); // Trick 7
		...
		rtnval.setCard(5,  new Card(1, 1, "THREE OF DIAMONDS")); // Trick 10
		rtnval.setCard(6,  new Card(1, 2, "THREE OF HEARTS")); // Trick 12
		rtnval.setCard(7,  new Card(9, 3, "JACK OF SPADES")); // Trick 6
		rtnval.setCard(8,  new Card(9, 1, "JACK OF DIAMONDS")); // Trick 8
		rtnval.setCard(9,  new Card(10, 3, "QUEEN OF SPADES")); // Trick 5
		...
		// Rcvd from Player 3:  QC (Trick 0), 8H (Trick 11), QH (Trick 9)
		
		// Player 1
		rtnval.setCard(13, new Card(1, 0, "THREE OF CLUBS"));  // Trick 12
		rtnval.setCard(14, new Card(12, 2, "ACE OF HEARTS"));  // Passed
		rtnval.setCard(15, new Card(7, 1, "NINE OF DIAMONDS")); // Trick 3
		rtnval.setCard(16, new Card(2, 0, "FOUR OF CLUBS"));  // Trick 11
		rtnval.setCard(17, new Card(3, 1, "FIVE OF DIAMONDS")); // Trick 10
		rtnval.setCard(18, new Card(4, 1, "SIX OF DIAMONDS")); // Trick 8
		rtnval.setCard(19, new Card(1, 3, "THREE OF SPADES")); // Trick 1
		rtnval.setCard(20, new Card(8, 1, "TEN OF DIAMONDS")); // Passed
		rtnval.setCard(21, new Card(6, 0, "EIGHT OF CLUBS")); // Trick 9
		rtnval.setCard(22, new Card(8, 0, "TEN OF CLUBS"));  // Passed
		rtnval.setCard(23, new Card(6, 1, "EIGHT OF DIAMONDS")); // Trick 4
		rtnval.setCard(24, new Card(4, 2, "SIX OF HEARTS"));  // Trick 6
		rtnval.setCard(25, new Card(0, 0, "DEUCE OF CLUBS"));  // Lead - Trick 0
		// Rcvd from Player 0:  2D (T7), 2H (T5), 2S (T2)
		...
		rtnval.setCard(30, new Card(7, 0, "NINE OF CLUBS")); // Trick 7
		rtnval.setCard(31, new Card(7, 2, "NINE OF HEARTS")); // Trick 9
		rtnval.setCard(32, new Card(3, 0, "FIVE OF CLUBS"));  // Trick 12
		rtnval.setCard(33, new Card(4, 3, "SIX OF SPADES")); // Trick 5
		rtnval.setCard(34, new Card(4, 0, "SIX OF CLUBS")); // Trick 11
		rtnval.setCard(35, new Card(5, 2, "SEVEN OF HEARTS")); // Trick 8
		rtnval.setCard(36, new Card(12, 0, "ACE OF CLUBS"));  // Trick 0
		rtnval.setCard(37, new Card(8, 2, "TEN OF HEARTS")); // Trick 6
		rtnval.setCard(38, new Card(2, 3, "FOUR OF SPADES")); // Trick 1
		// Rcvd from Player 1:  TC (Trick 10), TD (Trick 3), AH (Trick 4 - Hearts Broken)
		
		// Player 3
		rtnval.setCard(39, new Card(6, 2, "EIGHT OF HEARTS")); // Passed
		rtnval.setCard(40, new Card(7, 3, "NINE OF SPADES")); // Trick 1
		rtnval.setCard(41, new Card(3, 2, "FIVE OF HEARTS")); // Trick 7
		rtnval.setCard(42, new Card(3, 3, "FIVE OF SPADES")); // Trick 5
		rtnval.setCard(43, new Card(2, 2, "FOUR OF HEARTS")); // Trick 9
		rtnval.setCard(44, new Card(5, 0, "SEVEN OF CLUBS")); // Trick 12
		...
		rtnval.setCard(48, new Card(9, 2, "JACK OF HEARTS")); // Trick 10
		rtnval.setCard(49, new Card(9, 0, "JACK OF CLUBS")); // Trick 11
		rtnval.setCard(50, new Card(2, 1, "FOUR OF DIAMONDS")); // Trick 8
		rtnval.setCard(51, new Card(10, 2, "QUEEN OF HEARTS")); // Passed
		// Rcvd from Player 2:  KC (Trick 0), QD (Trick 3), KH (Trick 6)
